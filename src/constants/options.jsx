...
export const systemprompt=`Generate Travel Plan for location : {location}, for {totalDays} days for {traveller} people with a {budget} budget, Give me a Hotels options list with HotelName, Hotel address, Price, hotel image url, geo coordinates, ratings, descriptions and suggestion itinerary with placeName, Place Details, Place image URL, Geo Coordinates, ticket pricing, Time travels each of the location for {totalDays} with each day plan with best time to visit in JSON format.`
